<template>
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Register for Dashboard</h2>
      </div>
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" @submit.prevent="register">
          ...
          <div v-if="showAlert" class="mt-4 text-center text-sm" :class="{'text-red-500': alertType === 'error', 'text-green-500': alertType === 'success'}">
            {{ alertMessage }}
          </div>
        </form>
