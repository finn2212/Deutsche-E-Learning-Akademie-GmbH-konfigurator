...
import KurseKonfigurieren from '@/components/exportCoursesStepper/KurseKonfigurieren.vue'
import KurseExportieren from '@/components/exportCoursesStepper/KurseExportieren.vue'
