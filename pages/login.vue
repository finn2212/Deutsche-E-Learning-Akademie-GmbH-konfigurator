<template>
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Login to Dashboard
            </h2>
        </div>
            ...
            <form class="space-y-6" @submit.prevent="login">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <label href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Forgot password?
                                Contact Admin</label>
                        </div>
                    </div>
                    <div class="mt-2">
